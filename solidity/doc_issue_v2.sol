...
contract DocumentStorage is Initializable, UUPSUpgradeable, ReentrancyGuard {
  ...
  function revokeDocument(string calldata userId, string calldata docId)
    external
    nonReentrant
  {
    require(
  ...
  function getDocument(string calldata userId, string calldata docId)
    external
    view
  ...
  function getDocumentIds(string calldata userId)
    external
    view
  ...
  function getAllDocumentsForUser(string calldata userId)
    external
    view
